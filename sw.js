...
const VERSION = 'keys-v92';   // audit: the provenance exemption now applies to every rule, not three of four
const SHELL = [
  ...
  'js/songs-hands.mjs', 'js/songs-fingers.mjs', 'js/songs-fixed.mjs', 'js/hands.mjs', 'js/audio.mjs', 'js/echo.mjs',
